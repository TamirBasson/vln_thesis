...
def generate_launch_description():
    ...
    cartographer_launch = os.path.join(
        get_package_share_directory('robot_navigation'), 'launch', 'cartographer_real.launch.py')

    navigation_launch = os.path.join(
        get_package_share_directory('robot_navigation'), 'launch', 'navigation.launch.py')
    ...
    return LaunchDescription([
        ...
        # Step 6: Wait another 8s, then start Navigation
        TimerAction(
            period=23.0,
            actions=[
                IncludeLaunchDescription(
        ...
        # Step 7: Wait another 5s, then start Nav Goal Pose Node
        TimerAction(
            period=28.0,
            actions=[
                ExecuteProcess(
